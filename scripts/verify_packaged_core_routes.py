...
REQUIRED_PATHS = {
    ...
    "/codev/session",
    "/codev/pairing/claim",
    "/codev/pairing/action",
    "/codev/pairing/list",
    "/codev/pairing/revoke",
    "/codev/workspaces/select",
    "/codev/workspaces/tree",
    "/codev/workspaces/snapshot",
    "/codev/grants/issue",
    "/codev/grants/revoke",
    "/codev/patches/plan",
    "/codev/approvals/issue",
    "/codev/patches/apply",
    "/codev/commands/catalog",
    "/codev/commands/plan",
    "/codev/commands/start",
